    ...
    try {
      ...
      const response = await fetch(`/api/v1/ppt/rewrite/generate-rewritten-content`, {
        ...
        body: JSON.stringify({
          ...
          // All agent settings come from the settings page (Redux store)
          ...
          translation_parser_model: isTranslateMode ? llmConfig.TRANSLATION_PARSER_MODEL : undefined,
          translation_model: isTranslateMode ? llmConfig.TRANSLATION_MODEL : undefined,
          translation_batch_size: isTranslateMode ? llmConfig.TRANSLATION_BATCH_SIZE : undefined,
          translation_validator_model: isTranslateMode ? llmConfig.TRANSLATION_VALIDATOR_MODEL : undefined,
        }),
      })
