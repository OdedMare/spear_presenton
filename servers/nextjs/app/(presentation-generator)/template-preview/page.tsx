      ...
      <div className=" sticky top-0 z-30">
        <div className="max-w-7xl mx-auto border-b px-6 py-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900">כל התבניות</h1>
            <p className="text-gray-600 mt-2">
              {layoutTemplates.length} תבניות
            </p>
          </div>
        </div>
        {/* Custom Templates */}
        <section className="h-full pt-8 pb-8 flex justify-center items-center">
          <div className="max-w-7xl mx-auto px-6 py-6 w-full">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-900">תבניות AI מותאמות אישית</h2>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      צור את התבנית המותאמת אישית הראשונה שלך
                    </p>
                  </div>
                </Card>
              )}
        ...
        <section className="h-full pt-8 flex justify-center items-center">
          <div className="max-w-7xl mx-auto px-6 py-6 w-full">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">תבניות מובנות</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
