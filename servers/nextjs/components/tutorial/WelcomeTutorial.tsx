            ...
            >
                ...
                <div className="bg-gradient-to-r from-[#9034EA] to-[#5146E5] px-8 py-12 text-white text-center">
                    ...
                    <h1 className="text-4xl font-bold font-instrument_sans mb-3">
                        Welcome to Spear Presenton!
                    </h1>
                    <p className="text-xl text-white/90 max-w-2xl mx-auto">
                        Create stunning presentations with AI in minutes
                    </p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        ...
                        <motion.button
                            ...
                            className="group relative overflow-hidden rounded-xl border-2 border-gray-200 hover:border-[#5146E5] p-8 text-left transition-all bg-white hover:shadow-lg"
                        >
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#E9E8F8] rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform" />
                            ...
                            <div className="relative">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-4">
                                    Keep your presentation design, rewrite the content with AI. Perfect for updating existing decks.
                                </p>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-4">
                                    Generate a complete presentation from scratch using AI. Just describe what you need.
                                </p>
