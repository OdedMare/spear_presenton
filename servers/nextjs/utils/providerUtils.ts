...
export const updateLLMConfig = (
  ...
  const fieldMappings: Record<string, keyof LLMConfig> = {
    ...
    custom_template_llm_url: "CUSTOM_TEMPLATE_LLM_URL",
    custom_template_llm_api_key: "CUSTOM_TEMPLATE_LLM_API_KEY",
    custom_template_model: "CUSTOM_TEMPLATE_MODEL",
    ...
    force_adaptive_mode: "FORCE_ADAPTIVE_MODE",
  };
