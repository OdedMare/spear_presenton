...
const TwoColumnSlideLayoutComponent = ({ data }: { data: z.infer<typeof Schema> }) => {
    ...
    return (
        <div className="w-full max-w-[1280px] aspect-video mx-auto relative overflow-hidden rounded-md h-full flex" style={{ backgroundColor: '#f0fdf4' }}>
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ backgroundColor: '#15803d', color: '#f0fdf4' }}>
            ...
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ color: '#14532d' }}>
                <h3 className="text-3xl font-bold mb-6 border-b pb-4" style={{ borderColor: '#86efac' }}>{data.rightTitle}</h3>
