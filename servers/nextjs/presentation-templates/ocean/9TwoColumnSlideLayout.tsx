...
const TwoColumnSlideLayoutComponent = ({ data }: { data: z.infer<typeof Schema> }) => {
    ...
    return (
        <div className="w-full max-w-[1280px] aspect-video mx-auto relative overflow-hidden rounded-md h-full flex" style={{ backgroundColor: '#eff6ff' }}>
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ backgroundColor: '#1d4ed8', color: '#eff6ff' }}>
            ...
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ color: '#1e3a8a' }}>
                <h3 className="text-3xl font-bold mb-6 border-b pb-4" style={{ borderColor: '#93c5fd' }}>{data.rightTitle}</h3>
