...
const TwoColumnSlideLayoutComponent = ({ data }: { data: z.infer<typeof Schema> }) => {
    ...
    return (
        <div className="w-full max-w-[1280px] aspect-video mx-auto relative overflow-hidden rounded-md h-full flex" style={{ backgroundColor: '#ffffff' }}>
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ backgroundColor: '#18181b', color: '#ffffff' }}>
            ...
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ color: '#09090b' }}>
                <h3 className="text-3xl font-bold mb-6 border-b pb-4" style={{ borderColor: '#d4d4d8' }}>{data.rightTitle}</h3>
