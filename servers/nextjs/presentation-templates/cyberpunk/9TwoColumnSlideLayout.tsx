...
const TwoColumnSlideLayoutComponent = ({ data }: { data: z.infer<typeof Schema> }) => {
    ...
    return (
        <div className="w-full max-w-[1280px] aspect-video mx-auto relative overflow-hidden rounded-md h-full flex" style={{ backgroundColor: '#09090b' }}>
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ backgroundColor: '#d946ef', color: '#09090b' }}>
            ...
            <div className="w-1/2 p-16 flex flex-col justify-center" style={{ color: '#e4e4e7' }}>
                <h3 className="text-3xl font-bold mb-6 border-b pb-4" style={{ borderColor: '#22d3ee' }}>{data.rightTitle}</h3>
